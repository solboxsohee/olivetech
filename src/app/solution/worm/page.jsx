            ...
            <main className="main-content">
                <section className={styles.solLayout}>
                    ...
                    <div className={styles.solTxt}>
                        <article>
                            <p>
                                보안의 궁극적 목적은 조직의 핵심 데이터를 보호하는 것입니다.
                                스토리지에 저장된 데이터는 악성프로그램, 랜섬웨어, 외부 해커,
                                내부자에 의해 끊임없는 삭제.변조 위협에 노출되어 있습니다. 디지털
                                데이터는 권한을 가진 사용자에 의한 삭제.변조를 막을 수 없습니다.
                                이는 조직의 핵심 데이터에 대한 손실로 인한 막대한 피해, 법적으로
                                규정된 데이터 보존 규정 위배 등의 심각한 사태를 야기할 수 있습니다.
                            </p>
                            <p>
                ...
                <section className={styles.solLayout}>
                    ...
                    <article className={styles.solTxt}>
                        <p>
                            ...
                            인증을 받은 보안 스토리지 OS입니다. 국내 최초로 개발된 보안 스토리지
                            OS는 다수의 핵심 특허를 기반으로 하고 있으며 데이터의 삭제 및 변조를
                            방지하는 WORM 스토리지 핵심기능을 제공합니다. 보안 스토리지 OS는
                            일반적인 NAS 스토리지 기능을 기본으로 제공하고 있으며, 유료 WORM
                            라이선스를 통해 WORM 스토리지 기능을 제공하도록 업그레이드가
                            가능합니다.보안 스토리지 OS는 물리적 서버, 가상 서버, 클라우드 서버 및
                            범용 리눅스에 탑재하여 어떠한 환경에서나 WORM 스토리지 기능을 사용할 수
                            있게 해 주는 유연성을 제공합니다.
                        </p>
                    </article>
                </section>
